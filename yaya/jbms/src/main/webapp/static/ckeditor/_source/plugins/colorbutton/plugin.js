 ...
 * @type Boolean
 * @example
 * websocket.colorButton_enableMore = false;
 */
 ...
 * @example
 * // Brazil colors only.
 * websocket.colorButton_colors = '00923E,F8C100,28166F';
 * @example
 * websocket.colorButton_colors = 'FontColor1/FF9900,FontColor2/0066CC,FontColor3/F00'
 */
 ...
 * websocket.colorButton_foreStyle =
 *     {
 *         element : 'span',
 *         styles : { 'color' : '#(color)' }
 *     };
 ...
 * @example
 * // This is actually the default value.
 * websocket.colorButton_backStyle =
 *     {
 *         element : 'span',

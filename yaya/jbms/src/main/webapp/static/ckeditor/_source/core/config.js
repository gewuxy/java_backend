...
CKEDITOR.config =
{
	 ...
	 * overloaded with inline configuration, it defaults to the <code>websocket.js</code>
	 * file present in the root of the CKEditor installation directory.<br /><br />
	 *
	 * CKEditor will recursively load custom configuration files defined inside
	 * other custom configuration files.
	 * @type String
	 * @default <code>'<em>&lt;CKEditor folder&gt;</em>/websocket.js'</code>
	 * @example
	 ...
	 * @example
	 * websocket.autoUpdateElement = true;
	 */
	 ...
	 * @example
	 * websocket.baseHref = 'http://www.example.com/path/';
	 */
	baseHref : '',
	 ...
	 * @example
	 * websocket.contentsCss = '/css/mysitestyles.css';
	 * websocket.contentsCss = ['/css/mysitestyles.css', '/css/anotherfile.css'];
	 */
	 ...
	 * @type String
	 * @example
	 * websocket.contentsLangDirection = 'rtl';
	 */
	 ...
	 * @example
	 * // Not recommended.
	 * websocket.enterMode = CKEDITOR.ENTER_BR;
	 */
	 ...
	 * @example
	 * websocket.shiftEnterMode = CKEDITOR.ENTER_P;
	 */
	 ...
	 * code of CKEditor (<code>_source/core/websocket.js</code>).
	 * @type String
	 * @example
	 */
	corePlugins : '',
	 ...
	 * websocket.docType = '&lt;!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN"&gt;';
	 */
	 ...
	 * @example
	 * websocket.height = 500; // 500 pixels.
	 * @example
	 * websocket.height = '25em'; // CSS length.
	 * @example
	 * websocket.height = '300px'; // CSS length.
	 */
	height : 200,
	 ...
	 * @type String
	 * @example
	 * websocket.extraPlugins = 'myplugin,anotherplugin';
	 */
	extraPlugins : '',
	 ...
	 * @type String
	 * @example
	 * websocket.removePlugins = 'elementspath,save,font';
	 */
	removePlugins : '',
	 ...
	 * @example
	 * websocket.protectedSource.push( /<\?[\s\S]*?\?>/g );   // PHP code
	 * websocket.protectedSource.push( /<%[\s\S]*?%>/g );   // ASP code
	 * websocket.protectedSource.push( /(<asp:[^\>]+>[\s|\S]*?<\/asp:[^\>]+>)|(<asp:[^\>]+\/>)/gi );   // ASP.Net code
	 */
	protectedSource : [],
	 ...
	 * websocket.skin = 'v2';
	 * @example
	 * websocket.skin = 'myskin,/customstuff/myskin/';
	 */
	skin : 'kama',
	 ...
	 * @default <code>''</code> (empty)
	 * @example
	 * websocket.width = 850; // 850 pixels wide.
	 * @example
	 * websocket.width = '75%'; // CSS unit.
	 */
	width : '',
	 ...
	 * @example
	 * websocket.baseFloatZIndex = 2000
	 */
 ...
 * @since 3.4
 * @example
 * websocket.useComputedState = false;
 */

// PACKAGER_RENAME( CKEDITOR.websocket )

 ...
 * @example
 * websocket.coreStyles_bold = { element : 'b', overrides : 'strong' };
 * @example
 * websocket.coreStyles_bold =
 *     {
 *         element : 'span',
 ...
 * @example
 * websocket.coreStyles_italic = { element : 'i', overrides : 'em' };
 * @example
 * CKEDITOR.websocket.coreStyles_italic =
 *     {
 *         element : 'span',
 ...
 * @example
 * CKEDITOR.websocket.coreStyles_underline =
 *     {
 *         element : 'span',
 ...
 * @example
 * CKEDITOR.websocket.coreStyles_strike =
 *     {
 *         element : 'span',
 ...
 * @example
 * CKEDITOR.websocket.coreStyles_subscript =
 *     {
 *         element : 'span',
 ...
 * @example
 * CKEDITOR.websocket.coreStyles_superscript =
 *     {
 *         element : 'span',

 ...
 * @example
 * websocket.filebrowserBrowseUrl = '/browser/browse.php';
 */
 ...
 * @default <code>''</code> (empty string = disabled)
 * @example
 * websocket.filebrowserUploadUrl = '/uploader/upload.php';
 */
 ...
 * @default <code>''</code> (empty string = disabled)
 * @example
 * websocket.filebrowserImageBrowseUrl = '/browser/browse.php?type=Images';
 */
 ...
 * @default <code>''</code> (empty string = disabled)
 * @example
 * websocket.filebrowserFlashBrowseUrl = '/browser/browse.php?type=Flash';
 */
 ...
 * @default <code>''</code> (empty string = disabled)
 * @example
 * websocket.filebrowserImageUploadUrl = '/uploader/upload.php?type=Images';
 */
 ...
 * @default <code>''</code> (empty string = disabled)
 * @example
 * websocket.filebrowserFlashUploadUrl = '/uploader/upload.php?type=Flash';
 */
 ...
 * @default <code>''</code> (empty string = disabled)
 * @example
 * websocket.filebrowserImageBrowseLinkUrl = '/browser/browse.php';
 */
 ...
 * @example
 * websocket.filebrowserWindowFeatures = 'resizable=yes,scrollbars=no';
 */
 ...
 * @example
 * websocket.filebrowserWindowWidth = 750;
 * @example
 * websocket.filebrowserWindowWidth = '50%';
 */
 ...
 * @example
 * websocket.filebrowserWindowHeight = 580;
 * @example
 * websocket.filebrowserWindowHeight = '50%';
 */

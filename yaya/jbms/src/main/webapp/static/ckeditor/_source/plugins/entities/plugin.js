 ...
 * @default <code>true</code>
 * @example
 * websocket.entities_latin = false;
 */
 ...
 * @default <code>true</code>
 * @example
 * websocket.entities_greek = false;
 */
 ...
 * @example
 * websocket.entities_processNumerical = true;
 * websocket.entities_processNumerical = 'force';		//Converts from "&nbsp;" into "&#160;";
 */
 ...
 * @type String
 * @example
 * websocket.entities_additional = '#1049';		// Adds Cyrillic capital letter Short I (&#1049;).
 */

...
(function()
{
	...
	var loadConfig = function( editor )
	{
		...
		// Check if there is a custom websocket to load.
		if ( !customConfig )
			return false;
		...
		// If the custom websocket has already been downloaded, reuse it.
		if ( loadedConfig.fn )
		{
			// Call the cached CKEDITOR.editorConfig defined in the custom
			// websocket file for the editor instance depending on it.
			...
			CKEDITOR.scriptLoader.load( customConfig, function()
				{
					...
					// Call the load websocket again. This time the custom
					// websocket is already cached and so it will get loaded.
					loadConfig( editor );
				});
		}
	...
	var initConfig = function( editor, instanceConfig )
	{
		...
		editor.on( 'customConfigLoaded', function()
			{
				if ( instanceConfig )
				{
					...
					// Overwrite the settings from the in-page websocket.
		...
		// The instance websocket may override the customConfig setting to avoid
		// loading the default ~/websocket.js file.
	...
	{
		// Set websocket related properties.
	...
	CKEDITOR.editor.prototype._init = function()
		{
			 ...
			 * settings defined in <code>(@link CKEDITOR.websocket}</code>, combined with settings
			 ...
			 * @example
			 * var editor = CKEDITOR.instances.editor1;
			 * alert( <strong>editor.websocket.theme</strong> );  // E.g. "default"
			 */
 ...
 * @default false
 * @example
 * websocket.htmlEncodeOutput = true;
 */

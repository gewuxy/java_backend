...
CKEDITOR.plugins.add( 'image',
{
	...
	init : function( editor )
	{
		...
		// If the "contextmenu" plugin is loaded, register the cn.medcn.jcms.listener.
 ...
 * @default true
 * @example
 * websocket.image_removeLinkByEmptyURL = false;
 */
 ...
 * @example
 * websocket.image_previewText = CKEDITOR.tools.repeat( '___ ', 100 );
 */

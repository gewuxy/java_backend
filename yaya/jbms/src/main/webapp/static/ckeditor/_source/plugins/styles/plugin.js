...
CKEDITOR.editor.prototype.getStylesSet = function( callback )
{
	if ( !this._.stylesDefinitions )
	{
		...
		// #5352 Allow to define the styles directly in the websocket object
 ...
 * Previously this setting was available as websocket.stylesCombo_stylesSet<br>
 ...
 * websocket.stylesSet = 'mystyles';
 * @example
 * // Load from a relative URL.
 * websocket.stylesSet = 'mystyles:/editorstyles/styles.js';
 * @example
 * // Load from a full URL.
 * websocket.stylesSet = 'mystyles:http://www.example.com/editorstyles/styles.js';
 * @example

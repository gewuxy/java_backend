 ...
 * @default 'white'
 * @example
 * websocket.dialog_backgroundCoverColor = 'rgb(255, 254, 253)';
 */
 ...
 * @default 0.5
 * @example
 * websocket.dialog_backgroundCoverOpacity = 0.7;
 */
 ...
 * @default false
 * @example
 * websocket.dialog_startupFocusTab = true;
 */
 ...
 * @default 20
 * @example
 * websocket.dialog_magnetDistance = 30;
 */
 ...
 * @since 3.5
 * @example
 * websocket.dialog_buttonsOrder = 'rtl';
 */
 ...
 * @default ''
 * @example
 * websocket.removeDialogTabs = 'flash:advanced;image:Link';
 */

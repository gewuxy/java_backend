...
CKEDITOR.dom.domObject.prototype = (function()
{
	...
	return /** @lends CKEDITOR.dom.domObject.prototype */ {
		...
		on  : function( eventName )
		{
			...
			// only one cn.medcn.jcms.listener for a native event, which will then call all cn.medcn.jcms.listener
			// set to the event.

			// Get the listener holder object.
		...
		removeListener : function( eventName )
		{
			...
			// If we don't have listener for this event, clean the DOM up.

 ...
 * @default false
 * @example
 * websocket.forceSimpleAmpersand = false;
 */
 ...
 * @default true
 * @example
 * websocket.fillEmptyBlocks = false;	// Prevent filler nodes in all empty blocks.
 *
 * // Prevent filler node only in float cleaners.
 * websocket.fillEmptyBlocks = function( element )
 * {

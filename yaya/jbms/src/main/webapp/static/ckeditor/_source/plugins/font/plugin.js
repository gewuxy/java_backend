 ...
 * @type String
 * @example
 * websocket.font_names =
 *     'Arial/Arial, Helvetica, sans-serif;' +
 *     'Times New Roman/Times New Roman, Times, serif;' +
 *     'Verdana';
 * @example
 * websocket.font_names = 'Arial;Times New Roman;Verdana';
 */
 ...
 * websocket.font_defaultLabel = 'Arial';
 */
 ...
 * @example
 * websocket.fontSize_sizes = '16/16px;24/24px;48/48px;';
 * @example
 * websocket.fontSize_sizes = '12px;2.3em;130%;larger;x-small';
 * @example
 * websocket.fontSize_sizes = '12 Pixels/12px;Big/2.3em;30 Percent More/130%;Bigger/larger;Very Small/x-small';
 */
 ...
 * websocket.fontSize_defaultLabel = '12px';
 */

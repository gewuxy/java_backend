...
CKEDITOR.plugins.scayt =
	{
		...
		getUiTabs : function( editor )
		{
			...
			// "About us" should be always shown for standard websocket
			configUiTabs[3] = "1";
	...
	CKEDITOR.plugins.add( 'scayt',
	{
		...
		init : function( editor )
		{
			...
			// If the "contextmenu" plugin is loaded, register the listener.
 ...
 * @example
 * websocket.scayt_autoStartup = true;
 */
 ...
 * websocket.scayt_maxSuggestions = 3;
 * @example
 * // Do not show the suggestions directly.
 * websocket.scayt_maxSuggestions = -1;
 */
 ...
 * websocket.scayt_customerid  = 'your-encrypted-customer-id';
 */
 ...
 * websocket.scayt_moreSuggestions = 'off';
 */
 ...
 * websocket.scayt_contextCommands = 'add|ignoreall';
 */
 ...
 * @default <code>''</code>
 * @example
 * websocket.scayt_srcUrl = "http://my-host/spellcheck/lf/scayt/scayt.js";
 */
 ...
 * @default <code>''</code>
 * @example
 * websocket.scayt_customDictionaryIds = '3021,3456,3478"';
 */
 ...
 * @default <code>''</code>
 * @example
 * websocket.scayt_userDictionaryName = 'MyDictionary';
 */
 ...
 * @example
 * websocket.scayt_contextMenuItemsOrder = 'moresuggest|control|suggest';
 */

...
<ul class="nav nav-tabs">
    ...
    <shiro:hasPermission name="sys:region:add"><li><a href="${ctx}/sys/region/edit">添加医院</a></li></shiro:hasPermission>
</ul>
...
<form id="searchForm" action="${ctx}/sys/hospital/list" method="post" class="breadcrumb form-search">

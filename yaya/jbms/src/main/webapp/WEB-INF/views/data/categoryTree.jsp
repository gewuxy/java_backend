...
<script type="text/javascript">
    var setting = {
        ...
        async: { //动态加载
            enable: true,
            url:"${ctx}/data/category/treeData", //加载ztree
            autoParam:["id"],
            dataFilter: filter
        }
    };
    ...
    function filter(treeId, parentNode, childNodes) {
        ...
        for (var i in childNodes.data) {
            ...
            node.url="${ctx}/data/category/edit?id="+node.id;
    ...
    var treeSelectNodes = [
        {id: "0", preId: "0", name: "顶级栏目",url:"${ctx}/data/category/edit?id=0", target:"categoryFrame",
            isRoot:true},
        <c:forEach items="${list}" var="category">
        {
            ...
            url:"${ctx}/data/category/edit?id=${category.id}",

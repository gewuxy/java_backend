...
<ul class="nav nav-tabs">
    <li><a href="${ctx}/custom/menu/list">菜单列表</a></li>
    <li  class="active"><a href="${ctx}/custom/menu/edit">菜单${menu == null?"添加":"修改"}</a></li>
</ul>
<form id="inputForm" action="${ctx}/sys/menu/save" method="post" class="form-horizontal">
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <div class="input-append">
                ...
                <c:set var="parentName" scope="page" value="${parent == null?'顶级菜单':parent.menuName}"/>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input type="search" name="name" value="${menu.menuName}" maxlength="50" class="required input-xlarge"/>
        ...
        <div class="controls">
            <div class="input-append">
                <c:if test="${not empty menu.icon}">
                    <i></i><img src="${ctxStatic}/images/icon/${menu.icon}" align="absmiddle">
                </c:if>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input type="search" name="url"  maxlength="2000" value="${menu.href}" class="input-xlarge"/>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <select id="target" name="target" >
                <option value="mainFrame" ${menu.target eq 'mainFrame'|| menu.target == null?'selected':''}>内嵌网页</option>
                <option value="_blank" ${menu.target eq '_blank'?'selected':''}>新开网页</option>
            </select>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input name="perm" type="search" value="${menu.permission}" maxlength="100" class="input-xlarge"/>

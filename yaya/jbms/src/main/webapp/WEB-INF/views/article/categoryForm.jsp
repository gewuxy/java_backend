...
<form id="inputForm" action="${ctx}/article/category/save" method="post" class="form-horizontal">
    ...
    <div class="form-actions">
        ...
        <shiro:hasPermission name="article:category:add">
            <c:if test="${category.id != null && !category.leaf}"><input id="addBtn" class="btn" type="button" onclick="window.location.href = '${ctx}/article/category/edit?preId=${category.id}'" value="新 增"/>&nbsp;
            </c:if>
        </shiro:hasPermission>
        <shiro:hasPermission name="article:category:edit">
    ...
    $(document).ready(function() {
        ...
        $("#parentButton").click(function(){
            selecteIframe = layer.open({
                ...
                shade: [0.4, '#000'],
                maxmin: false,
                content: '${ctx}/article/category/treeData?preid=${category.preId}'
            });
        });
    });
    var selecteIframe;

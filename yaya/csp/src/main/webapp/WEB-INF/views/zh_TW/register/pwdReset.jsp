                        ...
                        <form action="${ctx}/api/email/doReset" name="resetForm" id="resetForm" method="post">
                            ...
                            <div class="login-form-item">
                                <label for="pwd" class="cells-block pr">
                                    <input type="text" required placeholder="輸入新密碼" class="login-formInput icon-register-hot last none" maxlength="24">
                                    <input id="pwd" type="password" name="password" required placeholder="輸入新密碼" class="login-formInput icon-register-hot hidePassword last" maxlength="24">
                                ...
                                <input id="submitBtn" type="button" class="button login-button buttonBlue last" value="確認密碼">
                            </div>
                        </form>
                    </div>

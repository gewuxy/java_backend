                ...
                <div class="row clearfix">
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="user-content item-radius">
                            <h4>視頻直播記錄 <span>剩余流量 <i><fmt:formatNumber type="number" value="${flux/1024}" maxFractionDigits="2"/></i>G</span></h4>
                                    ...
                                    <c:forEach items="${page.dataList}" var="v">
                                        <tr>
                                            ...
                                            <c:if test="${v.expireDay > 0}">
                                                ...
                                                <td class="col-w-2"><a  class="color-blue" id="download" href="javaScript:;" courseId="${v.courseId}">下載視頻</a></td>

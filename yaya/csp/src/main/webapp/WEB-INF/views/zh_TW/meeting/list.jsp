        ...
        $(function(){
            ...
            $('.more-hook').on('click',function(){
                ...
                mobShare.config({
                    ...
                    params: {
                        url: shareUrl, // 分享链接
                        title: '${nickname}' + " 正在使用【會講】講解 " + courseTitle, // 分享标题
        ...
        <div class="page-width clearfix pr">
            ...
            <c:if test="${expireTimeCount > 5}">
                <div class="admin-tips" id="pkTime">
                    <span class="admin-tips-main" id="yearTime"><a href="${ctx}/mgr/user/memberManage">有效期爲 <strong class="color-blue">${expireTimeCount}</strong> 天</a>
                    </span>
                ...
                <script>
                    $(function () {
                        ...
                        if(expireTimeCount>365){
                            ...
                            if(mounthCount<=0){
                                $("#yearTime").html('<a href="${ctx}/mgr/user/memberManage">有效期爲 <strong class="color-blue">'+yearCount+"年"+'</strong></a>')
                            }else {
                                $("#yearTime").html('<a href="${ctx}/mgr/user/memberManage">有效期爲 <strong class="color-blue">'+yearCount+'</strong> 年 <strong class="color-blue">'+mounthCount+'</strong> 個月</a>')
                            }
                        }
                    })
                </script>

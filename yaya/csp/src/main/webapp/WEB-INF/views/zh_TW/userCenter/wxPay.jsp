        ...
        <div class="page-width clearfix">
            ...
            <div class="subPage-main item-shadow item-radius wechat-state" >
                <div id="codeDiv">
                    ...
                    <p><img src="${ctxStatic}/images/icon-payment.png" alt="">&nbsp; 打開微信手機客護端掃壹掃</p>
                    <p id="active">距離二維碼過期還剩 <span class="color-red" id="time">50</span> 秒，過期後請刷新頁面重新獲取二維碼。</p>
                    <p class="color-red" id="inActive" style="display: none">二維碼已失效&nbsp;&nbsp;點擊<a href="javascript:;" class="color-blue" onclick="useOldCode()">重新</a>獲取二維碼</p>
                </div>
                    ...
                    <form action="">
                        <div class="login-form-item">
                            <div class="login-message-text login-message-text-2">
                                ...
                                <p>交易金额：&nbsp;<span class="color-blue" id="successAmount">200元</span>&nbsp;(人民幣)</p>
                            </div>
                            <input href="login-01.html" type="button" id="close" class="button login-button buttonBlue last" style="width:500px; margin:0 auto;" value="關閉頁面">
                        </div>
                    </form>
                </div>

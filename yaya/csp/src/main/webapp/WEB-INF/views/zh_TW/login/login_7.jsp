                ...
                <div class="col-lg-5 login-box-item">
                        ...
                        <form action="${ctx}/mgr/login" method="post" id="loginForm" name="loginForm">
                            ...
                            <div class="login-form-item">
                                ...
                                <label for="pwd" class="cells-block pr">
                                    ...
                                    <input id="pwd" name="password" type="password" required placeholder="輸入6~24位密碼" class="login-formInput icon-register-hot hidePassword last" maxlength="24">
                                ...
                                <input type="button" class="button login-button buttonBlue last" id="submitBtn" value="確認登錄">
                            </div>
                        </form>
                    </div>
                    ...
                    <div class="login-box-other">
                        <div class="login-box-other-info t-center">
                            <a href="${ctx}/mgr/to/register" class="color-wathet-blue">我要註冊</a><span class="muted">|</span><a href="${ctx}/mgr/to/reset/password" class="color-wathet-blue">忘記密碼</a>
                        </div>
                    </div>
...
<script>
    $(function(){
        ...
        const userNameError = "請輸入正確的郵箱地址";
        const passWordError = "請輸入正確的密碼";

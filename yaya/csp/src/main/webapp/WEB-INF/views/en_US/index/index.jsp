        ...
        <div class="page-width pr">
            <div class=" index-login">
                <div class="fr clearfix">
                    ...
                    <a href="javascript:;" class="index-download index-qrcode">Download App<span class="qrcode-01 qrcode-top"><img id="qrCode" src="${ctxStatic}/upload/img/qrcode.png" alt=""></span></a>
                </div>
            </div>
        </div>

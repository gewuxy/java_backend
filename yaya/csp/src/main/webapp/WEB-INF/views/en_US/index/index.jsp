...
<div id="wrapper" class="index-box">
    <div class="header">
        <div class="page-width pr">
            <div class=" index-login">
                <div class="fr clearfix">
                    ...
                    <a href="${ctx}/login"
                       class="user-login-button"><strong>${not empty username ? username : "Login"}</strong>&nbsp;&nbsp;<i></i>
                    </a>
                    <a href="javascript:;" class="index-download index-qrcode">Download App<span
                            class="qrcode-01 qrcode-top"><img id="qrCode" src="${ctxStatic}/upload/img/qrcode.png"
                                                              alt=""></span></a>
                </div>
            </div>
        </div>
        <div class="banner index-banner-img">
            <div class="index-banner-content not-animated" data-animate="fadeIn" data-delay="200">
                <h3 class="fontStyleSubHead not-animated" data-animate="fadeInDown" data-delay="300"><img
                        src="${ctxStatic}/images/index-logo-en.png" alt=""></h3>
                <h2 class="not-animated" data-animate="fadeInDown" data-delay="300">Spread your insights</h2>
                <h4 class="not-animated" data-animate="fadeIn" data-delay="500">Deliver your presentation with mobile&nbsp;:&nbsp;presenting,
                    recording and <br/>sharing anytime, anywhere! </h4>
    ...
    <div class="content">
                                ...
                                <div class="row shadow-layer-top">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="functional-item">
                                            ...
                                            <div class="main">
                                                <p>Everyone can preside, record and release a meeting simultaneously
                                                    with no more than one mobile <br/> phone + one App.</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="functional-item">
                                            ...
                                            <div class="main">
                                                <p>Free switching between meeting record and projection live stream, or
                                                    between audio and video in multiple meeting scenarios.</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="functional-item">
                                            ...
                                            <div class="main">
                                                <p>Projective live stream on site with real-time transmit to cloud
                                                    allows you to record, preserve and play simultaneously.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="functional-item">
                                            ...
                                            <div class="main">
                                                <p>No need to wait for the end of live stream – CSP supports instant
                                                    playback of anything <br/> you just missed.</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="functional-item">
                                            ...
                                            <div class="main">
                                                <p>The advanced coding algorithms, including intelligent echo
                                                    elimination, automatic gain control and automatic white noise,
                                                    ensure the quality <br/> of your meeting.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="functional-item ">
                                            ...
                                            <div class="main">
                                                <p>CSP connects to global mainstream social platform (e.g. Facebook,
                                                    Twitter and Wechat). By one-click sharing, you can enhance your
                                                    meeting <br/> influence and build your personal brand.</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="application-item clearfix ">
                                        <div class="clearfix">
                                            ...
                                            <div class="application-hover-text">
                                                ...
                                                <p>
                                                    <span> CSP enables a new form of PPT presentation with mobile phone.</span>
                                                </p>
                                                <p>
                                                    <span> With the help of recording-in-lecturing and one-click-sharing,</span>
                                                </p>
                                                <p><span> students can review the contents any time. </span></p>
                                                <p><span> Academic institution can ensure the quality of training with CSP.</span>
                                                </p>
                                    ...
                                    <div class="application-item clearfix">
                                        <div class="clearfix">
                                            ...
                                            <div class="application-hover-text">
                                                ...
                                                <p><span> Internal trainings and multilateral conferences could</span>
                                                </p>
                                                <p>
                                                    <span> proceed in CSP regardless of location and number of attendees.</span>
                                                </p>
                                                <p>
                                                    <span>  Real-time assignment delivery and live stream + chat-room</span>
                                                </p>
        ...
        <div class="module-section"
             style="background:#ffffff url(${ctxStatic}/images/index-module-bg-01.jpg) no-repeat center top;">
            <div class="module-section-inner">
                ...
                <div class="page-width">
                    ...
                    <div class="module-section-content">
                        <div class="row">
                            <div class="col-lg-4">
                                <h3 style="line-height: 1.4; margin-bottom:20px; font-size: 26px; font-weight: normal;"
                                    class="color-blue">Higher Speed</h3>
                                <p style="font-size:16px; padding-right:50px;">Through the integration of web cloud
                                    technology and App, CSP breaks through the limitation of device, bandwidth and
                                    process in traditional video conference, realizing essential real-time
                                    synchronization in cloud and playback.
                                </p>
                            </div>
                            <div class="col-lg-4">
                                <h3 style="line-height: 1.4; margin-bottom:20px; font-size: 26px; font-weight: normal;"
                                    class="color-blue">Less Consumption</h3>
                                <p style="font-size:16px;  padding-right:50px;">The leading real-time stream processing
                                    technology and expressive form of “PPT + audio” saves you at least 80% of network
                                    flow comparing to other live stream service, while remaining the high image quality
                                    and low noise.
                                </p>
                            </div>
                            <div class="col-lg-4">
                                <h3 style="line-height: 1.4; margin-bottom:20px;font-size: 26px; font-weight: normal;"
                                    class="color-blue">More Convenience</h3>
                                <p style="font-size:16px;  padding-right:30px;">Multiple meeting modes and one-click
                                    sharing to multiple terminals enhance your influence rapidly.
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="module-section-inner">
                ...
                <div class="page-width">
                            ...
                            <div class="index-buy-main">
                                ...
                                <div class="index-buy-text">
                                    <ul>
                                        <li class="icon-li-selected">Projective Record</li>
                                        <li class="icon-li-selected">Projective Live Stream</li>
                                        <li class="icon-li-selected">Watermark Switch</li>
                    ...
                    <div class="index-buy-button t-center">
                        <a href="${ctx}/login" class="button item-radius">Try Now</a>
                    </div>
        ...
        <div class="module-section module-section-gray"
             style="background:#F9FCFF url(${ctxStatic}/images/img/index-shadow-bg.png) no-repeat center;">
            ...
            <div class="module-section-inner">
                <div class="page-width">
                    <div class="module-section-content index-info">
                        <div class="row">
                            <div class="col-lg-7">
                                <h3 class="color-black">Global Leading Meeting System<br/>with Cloud Synchronization
                                    Playback</h3>
                            </div>
                            <div class="col-lg-5 pr">
                                <div class="index-playback-img"><img src="${ctxStatic}/images/img/Shadow-en.png" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="footer">
        <div class="page-width">
            <p class="t-center"><a href="${ctx}/index/17103116215880292674" class="color-black">About Us</a><span
                    class="muted">|</span><a href="${ctx}/index/17103116063862386794" class="color-black">Support</a>
            </p>

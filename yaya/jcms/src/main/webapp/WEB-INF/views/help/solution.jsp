    ...
    <div class="page-width clearfix">
        <div class="v2-helpPage-Menu clearfix">
            <ul>
                ...
                <li><a href="${base}/help/feedback">意见反馈</a></li>
        ...
        <div class="v2-helpPage-tabs clearfix">
            ...
            <div class="tab-box ">
                ...
                <div class="tab-box-content">
                    <div class="v2-helpPage-item">
                        ...
                        <p class="v2-fq-text">A: 合理用药YaYa目前支持iPhone、Android系统。您可以到 <a href="http://www.medcn.com/mc/hlyy" class="color-blue"><img src="${statics}/images/v2/icon-link.png" alt="">合理用药</a> 下载。</p>
                    </div>
                    <div class="v2-helpPage-item">
            ...
            <div class="tab-box clearfix">
                ...
                <div class="tab-box-content">
                    ...
                    <div class="v2-helpPage-item">
                        <h4>Q:我能自己发起会议吗？</h4>
                        <p class="v2-fq-text">A:可以的，您可在 <a href="https://yyks.medyaya.cn/web/regist/regist?from=yaya" class="color-blue"><img src="${statics}/images/v2/icon-link.png" alt="">申请链接</a>   申请开通公众号，通过审核后，便可通过YaYa医师公众号平台自行发起和管理自己的会议。 </p>
                    </div>
                    <div class="v2-helpPage-item">
            ...
            <div class="tab-box clearfix">
                ...
                <div class="tab-box-content">
                        ...
                        <div class="formrow">
                            <table class="formPriceTable fs14 formInfoTable" style="width:100%" cellspacing="0">
                                ...
                                <tr>
                                    ...
                                    <td><img src="${statics}/images/v2/icon_true2.png" alt=""></td>
                                    <td><img src="${statics}/images/v2/icon_true2.png" alt=""></td>
                                </tr>
                                <tr>
                    ...
                    <div class="v2-helpPage-item">
                        <h4>Q：如何申请开通套餐？</h4>
                        <p class="v2-fq-text">A:点击 &nbsp;<a href="https://yyks.medyaya.cn/web/regist/regist?from=yaya" class="color-blue"><img src="${statics}/images/v2/icon-link.png" alt="">申请链接</a> 直接申请，或发邮件至service@medcn.cn 我们会有专门负责的同事与您联系。</p>
                    </div>
                    <div class="v2-helpPage-item">
                        <h4>Q:如何找回密码？</h4>
                        <p class="v2-fq-text">A:可以发送您的用户名到 <img src="${statics}/images/v2/icon-link.png" alt=""><a href="mailto:service@medcn.cn" class="color-blue">service@medcn.cn</a> 找回您的密码。</p>
                    </div>
                    <div class="v2-helpPage-item">

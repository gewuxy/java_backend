                            ...
                            <c:if test="${qtype == 0 || qtype == 1}">
                                <div class="title_itram" id="optionView">
                                    <div class="kzjxx_iteam">
                                        <input name="rightKeyArr" type="${qtype == 0?'radio':'checkbox'}"  value="1"
                                            <c:if test="${question.qtype == 0 && question.rightKeyArr eq op.key}">checked</c:if>
                                               <c:if test="${question.qtype == 1 && fn:contains(question.rightKeyArr, op.key)}">checked</c:if>
                                               class="dxk">
                                    ...
                                    <div class="kzjxx_iteam">
                                        <input name="rightKeyArr" type="${qtype == 0?'radio':'checkbox'}"  value="2"
                                               <c:if test="${question.qtype == 0 && question.rightKeyArr eq op.key}">checked</c:if>
                                               <c:if test="${question.qtype == 1 && fn:contains(question.rightKeyArr, op.key)}">checked</c:if>
                                               class="dxk">
                                        <input name="optionArr" type="text" class="input_wenbk option" value="${op.value}" placeholder="选择项内容">
                                        <a href="javascript:void(0);" class="del_xm">删除</a> </div>
                                    <div class="kzjxx_iteam">
                                        <input name="rightKeyArr" type="${qtype == 0?'radio':'checkbox'}"  value="3"
                                               <c:if test="${question.qtype == 0 && question.rightKeyArr eq op.key}">checked</c:if>
                                               <c:if test="${question.qtype == 1 && fn:contains(question.rightKeyArr, op.key)}">checked</c:if>
                                               class="dxk">
                                        <input name="optionArr" type="text" class="input_wenbk option" value="${op.value}" placeholder="选择项内容">
                                        <a href="javascript:void(0);" class="del_xm">删除</a> </div>
                                    <div class="kzjxx_iteam">
                                        <input name="rightKeyArr" type="${qtype == 0?'radio':'checkbox'}"  value="4"
                                               <c:if test="${question.qtype == 0 && question.rightKeyArr eq op.key}">checked</c:if>
                                               <c:if test="${question.qtype == 1 && fn:contains(question.rightKeyArr, op.key)}">checked</c:if>
                                               class="dxk">
                                        <input name="optionArr" type="text" class="input_wenbk option" value="${op.value}" placeholder="选择项内容">
    ...
    <script>
        $(function(){
            ...
            $(".xxk_title>li").click(function(){
                ...
                window.location.href = '${ctx}/func/meet/exam/edit?paperId=${paperId}&qtype='+qtype;
            });

            ...
            <div id="responsive-01">
                <div class="carousel-item">
                    <div class="carousel-img">
                        <a>
                            <img src="${statics}/images/upload/joinBanner.jpg" alt="" />
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="page-width clearfix">
                ...
                <div class="module-full-screen-content" >
                    <div class="row v2-join-info" >
                        <div class="col-lg-2">
                            <p class="t-center"><img src="${statics}/images/upload/join-img3.png" alt=""></p>
                            <p class="t-center">5天工作制</p>
                        </div>
                        <div class="col-lg-2">
                            <p class="t-center"><img src="${statics}/images/upload/join-img6.png" alt=""></p>
                            <p class="t-center">5天带薪年假</p>
                        </div>
                        <div class="col-lg-2">
                            <p class="t-center"><img src="${statics}/images/upload/join-img2.png" alt=""></p>
                            <p class="t-center">五险一金</p>
                        </div>
                        <div class="col-lg-2">
                            <p class="t-center"><img src="${statics}/images/upload/join-img1.png" alt=""></p>
                            <p class="t-center">年终奖</p>
                        </div>
                        <div class="col-lg-2">
                            <p class="t-center"><img src="${statics}/images/upload/join-img4.png" alt=""></p>
                            <p class="t-center">工作餐</p>
                        </div>
                        <div class="col-lg-2">
                            <p class="t-center"><img src="${statics}/images/upload/join-img5.png" alt=""></p>
                    ...
                    <div class="v2-join">
                        <div class="v2-join-item">
                            <h3 class="v2-join-item-title clearfix">
                                <img src="${statics}/images/upload/_join-img1.png" alt="" class="fl">
                                <div class="oh">
                                    <span>Java开发工程师</span>
                                </div>
                            </h3>
                        ...
                        <div class="v2-join-item">
                            <h3 class="v2-join-item-title clearfix">
                                <img src="${statics}/images/upload/_join-img2.png" alt="" class="fl">
                                <div class="oh">
                                    <span>软件测试工程师</span>
                                </div>
                            </h3>
                        ...
                        <div class="v2-join-item">
                            <h3 class="v2-join-item-title clearfix">
                                <img src="${statics}/images/upload/_join-img3.png" alt="" class="fl">
                                <div class="oh">
                                    <span>运维工程师</span>
                                </div>
                            </h3>
                        ...
                        <div class="v2-join-item">
                            <h3 class="v2-join-item-title clearfix">
                                <img src="${statics}/images/upload/_join-img4.png" alt="" class="fl">
                                <div class="oh">
                                    <span>产品运营</span>
                                </div>
                            </h3>

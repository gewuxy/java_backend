    ...
    <div class="v2-sub-main">
        <div class=" v2-about-bg">
            <div class="page-width clearfix">
                <p class="t-center" style="padding-top:240px;"><img src="${statics}/images/upload/about-title1.png" alt=""></p>
                <p style="font-size:0;"><img src="${statics}/images/upload/about-title-img.png" alt=""></p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-5 col-lg-offset-1">
                            ...
                            <div class="v2-about-viedo">
                                <!--<img src="${statics}/images/upload/_about-viedo-img.jpg" alt="">-->
        ...
        <div class="v2-full-area v2-banner-gray v2-about-team">
            <div class="page-width clearfix">
                <h3 class="title">我们团队/Our Team  <a href="${base}/team" class="fr more v2-about-team-more">点这查看大部队</a></h3>
                <div class="v2-about-team-item">
                    <ul>
                        ...
                        <li class="last v2-team-join-button">
                            <a href="${base}/joinus">
                                <div class="v2-about-team-img"><img src="${statics}/images/upload/team-join.png" alt=""></div>
                            </a>
                        </li>
                    </ul>
                    ...
                    <ul>
                        <li>
                            <a href="https://www.thomsonreuters.cn/zh.html" target="_blank">
                                <img src="${statics}/images/upload/_links_01.png" alt="">
                                <p>THOMSON REUTERS 汤森路透</p>
                            </a>
                        </li>
                        <li>
                            <a href="http://www.fjxiehe.com/" target="_blank">
                                <img src="${statics}/images/upload/_links_02.png" alt="">
                                <p>福建医科大学附属协和医院</p>
                            </a>
                        </li>
                        <li>
                            <a href="http://www.fzcrb.com/" target="_blank">
                                <img src="${statics}/images/upload/_links_03.png" alt="">
                                <p>福建医科大学孟超肝胆医院</p>
                            </a>
                        </li>
                        <li>
                            <a href="http://www.bqejj.com/" target="_blank">
                                <img src="${statics}/images/upload/_links_04.png" alt="">
                                <p>白求恩基金管理委员会</p>
                            </a>
                        </li>
                        <li>
                            <a href="http://www.syphu.edu.cn/" target="_blank">
                                <img src="${statics}/images/upload/_links_05.png" alt="">
                                <p>沈阳药科大学</p>
                            </a>
                        </li>
                        <li class="last">
                            <a href="http://www.bjsn.org/" target="_blank">
                                <img src="${statics}/images/upload/_links_06.png" alt="">
                                <p>北京神经科学学会</p>
                            </a>
                        </li>
                        <li>
                            <a href="http://www.gyfyy.com/" target="_blank">
                                <img src="${statics}/images/upload/_links_07.png" alt="">
                                <p>广州医科大学附属第一医院</p>
                            </a>
                        </li>
                        <li>
                            <a href="http://www.gyey.com/cn/index.aspx" target="_blank">
                                <img src="${statics}/images/upload/_links_12.png" alt="">
                                <p>广州医科大学附属第二医院</p>
                            </a>
                        </li>
                        <li>
                            <a href="http://www.sdzydfy.com/web/index.asp" target="_blank">
                                <img src="${statics}/images/upload/_links_08.png" alt="">
                                <p>山东省中医院</p>
                            </a>
                        </li>
                        <li>
                            <a href="http://www.aqslyy.com.cn/" target="_blank">
                                <img src="${statics}/images/upload/_links_09.png" alt="">
                                <p>安庆市立医院</p>
                            </a>
                        </li>
                        <li>
                            <a href="http://www.ptws.gov.cn/" target="_blank">
                                <img src="${statics}/images/upload/_links_10.png" alt="">
                                <p>莆田市卫计委</p>
                            </a>
                        </li>
                        <li class="last">
                            <a href="http://www.wangao.com.cn/" target="_blank">
                                <img src="${statics}/images/upload/_links_11.png" alt="">
                                <p>万高药业</p>
                            </a>
                        </li>
                    </ul>
        ...
        <style>
            .BMap_Marker { background:url(${statics}/images/v2/icon-maps.png) no-repeat !important; }
        </style>
            ...
            <div class="page-width clearfix">
                ...
                <div class="formrow">
                    ...
                    <div class="formControls">
                        <p><img src="${statics}/images/v2/icon-location.png" alt="" style="margin:0 20px 0 10px;">总部地址：广州市天河区珠江新城兴民路222号天盈广场西塔2603</p>
                        <p><img src="${statics}/images/v2/icon-email.png" alt="" style="top:0; margin:0 20px 0 10px;">邮箱：<a href="mailto:service@medcn.cn">service@medcn.cn</a>
                        </p>
                    </div>
                </div>
            </div>

...
<head>
    ...
    <script src="${statics}/js/formatDate.js"></script>
    <style type="text/css">
        .shenglue{
            width: 280px;  /*必须设置宽度*/
...
<div id="wrapper" class="v2-medcnIndex">
    <%@include file="/WEB-INF/include/header_index.jsp"%>

    <div class="v2-banner bg-lightBlue">
        <div class="page-width clearfix">
            <div class="fr">
                <div class="v2-index-download-area clearfix v2-hover-shadow" style="margin-bottom:20px;">
                    <p class="t-center margin-b"><img src="${statics}/images/upload/_index_minBanner_area_img1.png" alt="合理用药APP 呵护你的健康"></p>
                    <div class="fr">
                        <p class="margin-b"><a href="${base}/mc/hlyy" class="v2-index-download-button"><img src="${statics}/images/v2/download-button-apple.png" alt=""></a></p>
                        <p><a href="${base}/mc/hlyy" class="v2-index-download-button"><img src="${statics}/images/v2/download-button-android.png" alt=""></a></p>
                    </div>
                    <div class="fl t-center"><img src="${statics}/images/upload/jk-erweima.png" alt="" style="width:90px; height:90px;"><p >扫描二维码下载</p></div>

                </div>
                <div class="oh v2-hover-shadow">
                    <a href="${base}/login" style=" display:block; line-height: 1; margin:0; padding:0;"><img src="${statics}/images/upload/min-ad-01.jpg" alt=""></a>
                </div>
                    ...
                    <div id="carousel-05">
                        <div class="carousel-item">
                            <div class="carousel-img">
                                <a  target="_blank">
                                    <img src="${statics}/images/upload/_banner_170228_1.jpg" alt="" />
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3">
                        <div class="v2-news-list">
                            <div class="v2-news-title">
                                <a href="${base}/news/trends" class="more fr">更多&gt;&gt;</a>
                                <h3>公司动态</h3>
                            </div>
...
//                                    next 		: { button:"#carousel-next-01"},
    ...
    $(function(){
        $.get('${base}/news/ajaxTrends',{'pageNum':1,'pageSize':6}, function (data) {
            if(data.code == 0){
                for(var index in data.data.dataList){
                    $("#trendsUL").append('<li title="'+data.data.dataList[index].title+'" class="shenglue"><a href="${base}/news/viewtrend/'+data.data.dataList[index].id+'">'+data.data.dataList[index].title+'</a></li>');
                }
            }
        },'json');

        $.get('${base}/news/pagenews',{'pageNum':pageNum,'pageSize':11},function (data) {
            if(data.code == 0){
                showNews(data);
            }
        },'json');
        ...
        $(".v2-more-button").click(function(){
            $.get('${base}/news/pagenews',{'pageNum':pageNum+1,'pageSize':12},function (data) {
                if(data.code == 0){
                    showNews(data);
                    autoPageable = true;
                    pageNum++;
        ...
        if(data.data.dataList.length > 0){
            for(var index in data.data.dataList){
                ...
                var addhtml = '<div class="col-lg-3">'
                    ...
                    +'<a href="${base}/news/view/'+data.data.dataList[index].id+'" target="_blank"><img src="'+data.data.dataList[index].articleImg+'" alt=""></a>'
                    +'<i class="v2-entry-classIcon"><a href="${base}/news/view/'+data.data.dataList[index].id+'">'+keyword+'</a></i>'
                    +'</div>'
                    +'<div class="v2-entry-title">'
                    +'<h5><a href="${base}/news/view/'+data.data.dataList[index].id+'" target="_blank">'+data.data.dataList[index].title+'</a></h5>'

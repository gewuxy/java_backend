...
<head>
    ...
    <link href="${statics}/css/yis-app.css" rel="stylesheet" type="text/css" />
    ...
    <div class="v2-sub-main clearfix">
        <div class="yis-intr">
            <div class="yis-content">
                <div class="yis">
                    <img src="${statics}/images/yaya.png"  />
                    <div class="yispt">
                        <p>YaYa医师</p>
                        <p>每位医生都是一个品牌</p>
                    </div>
                    ...
                    <div class="yierw">
                        <div class="yisdown">
                            <p><a href="http://139.199.170.178/apkfile/YaYa_v7.1.70.apk"> <input name="button" type="button" class="yis-azxz" value="Android下载" /></a></p>

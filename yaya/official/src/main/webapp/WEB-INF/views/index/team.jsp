            ...
            <div id="carousel-05">
                <div class="carousel-item">
                    <div class="carousel-img">
                        <a href="${base}/joinus">
                            <img src="${ctxStatic}/images/upload/teamListBanner.jpg" alt="" />
                        </a>
                    </div>
                </div>
            </div>
                ...
                <div class="v2-about-team-item">
                    <ul>
                        ...
                        <li>
                            <a>
                                <div class="v2-about-team-img">
                                    <i class="v2-about-team-bg"></i><img src="${ctxStatic}/images/upload/team14.png" alt=""></div>
                        ...
                        <li>
                            <a>
                                <div class="v2-about-team-img">
                                    <i class="v2-about-team-bg"></i><img src="${ctxStatic}/images/upload/team8.png" alt=""></div>
                        ...
                        <li>
                            <a>
                                <div class="v2-about-team-img">
                                    <i class="v2-about-team-bg"></i><img src="${ctxStatic}/images/upload/team15.png" alt=""></div>
                        ...
                        <li >
                            <a>
                                <div class="v2-about-team-img">
                                    <i class="v2-about-team-bg"></i><img src="${ctxStatic}/images/upload/team12.png" alt=""></div>
                        ...
                        <li  class="last">
                            <a>
                                <div class="v2-about-team-img">
                                    <i class="v2-about-team-bg"></i><img src="${ctxStatic}/images/upload/team17.png" alt=""></div>
                        ...
                        <li>
                            <a>
                                <div class="v2-about-team-img">
                                    <i class="v2-about-team-bg"></i><img src="${ctxStatic}/images/upload/team20.png" alt=""></div>
                        ...
                        <li>
                            <a>
                                <div class="v2-about-team-img">
                                    <i class="v2-about-team-bg"></i><img src="${ctxStatic}/images/upload/team11.png" alt=""></div>
                        ...
                        <li class="last">
                            <a>
                                <div class="v2-about-team-img">
                                    <i class="v2-about-team-bg"></i><img src="${ctxStatic}/images/upload/team22.png" alt=""></div>

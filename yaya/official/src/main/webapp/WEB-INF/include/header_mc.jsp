...
<div class="v2-top v2-header1 fixed-nav">
    <div class="v2-top-main">
        <div class="page-width clearfix">
            <div class="logo" >
                <a href="${ctx}/" >
                    <img src="${ctxStatic}/images/v2/logo-phone.png" alt=""  />
                </a>
            </div><!-- end of logo -->
                    ...
                    <div class="main-nav phonePage-main-nav clearfix" >
                        <ul class="sf-menu" >
                            <li <c:if test="${type == 'hlyy'}">class="current"</c:if> >
                                <a class="first-level" href="${ctx}/mc/hlyy"><strong>合理用药</strong></a>
                            </li>
                            <li <c:if test="${type=='yis'}">class="current"</c:if>>
                                <a class="first-level last" href="${ctx}/mc/yis"><strong>YaYa医师</strong></a>

                            </li>
                            <%--<li <c:if test="${type=='yaos'}">class="current"</c:if>>
                                <a class="first-level" href="${ctx}/mc/yaos"><strong>YaYa药师</strong></a>
                            </li>--%>
                        </ul>
                    </div>
                </nav>

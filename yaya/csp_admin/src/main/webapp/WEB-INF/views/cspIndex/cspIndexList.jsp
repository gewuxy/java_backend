...
<div class="top-info clearfix">
    <div class="row-fluid ">
        <div class="row-span span4">
            <h6 class="title"><a href="${ctx}/sys/register/stats/home?location=0">昨日新增</a></h6>
            <p><strong class="price">${newUserCount}</strong></p>
        </div>
        <div class="row-span span4">
            <h6 class="title"><a href="${ctx}/csp/stats/money?type=0">昨日进账</a></h6>
            <p><strong class="price">${newMoney}</strong></p>
        </div>
        <div class="row-span span4">
            <h6 class="title"><a href="${ctx}/csp/user/list?listType=0">总用户</a></h6>

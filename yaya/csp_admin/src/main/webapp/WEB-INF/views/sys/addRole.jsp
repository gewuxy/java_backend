...
<form id="inputForm" action="${ctx}/sys/role/add" method="post" class="form-horizontal">
    <div class="control-group">
        ...
        <div class="controls">
            <input type="search" id="roleName" name="roleName" maxlength="50" class="required abc" />
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input type="search" name="roleDesc" id="roleDesc"  maxlength="50" class="required realName"/>
            <span class="help-inline"><font color="red">*</font> </span>
        </div>
    </div>

...
<div id="main">
    <div id="header" class="navbar navbar-fixed-top">
        <div class="navbar-inner">
            <div class="brand"><a href="http://www.medcn.com" target="_blank"><img src="${ctxStatic}/images/logo.png"
                                                                                   alt="logo"/></a></div>
    ...
    <div class="container-fluid">
                ...
                <div class="accordion" id="menu-1">
                    <div class="accordion-group">
                        <div class="accordion-heading">
                            <a class="accordion-toggle" data-toggle="collapse" data-parent="#menu-1"
                               data-href="#collapse-1" href="#collapse-1" title=""><i
                                    class="icon-chevron-down"></i>&nbsp;菜单导航
                            </a>
                        </div>
                        <div id="collapse-${menu.id}"
                            ...
                            <div class="accordion-inner">
                                <ul class="nav nav-list">
                                    <li><a
                                           href="${ctx}/example/table"
                                           target="mainFrame"><i
                                            class="icon-circle-arrow-right"></i>&nbsp;表格示例
                                    </a>
                                    </li>
        ...
        <div id="footer" class="row-fluid">
            Copyright &copy; 2012-<span id="copyRightLastYear"></span> - Powered By <a href="http://www.medcn.com"
                                                                                       target="_blank">广州敬信药草园科技有限公司</a>
        </div>
    </div>
</div>
<script type="text/javascript">

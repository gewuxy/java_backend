...
<form id="inputForm" method="post" class="form-horizontal" action="${ctx}/yaya/banner/update"
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input type="search" name="weight"  id="weight" maxlength="50" class="required input-large" value="${banner.weight}" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')">
